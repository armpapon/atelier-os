...
export const CHANGELOG = [
  {
    version: 'v3.34',
    date: '2026-07-13',
    title: 'Journal · เมลค้างตอบไม่นับที่ลูกค้าแค่กด emoji ตอบ',
    badge: 'Current',
    changes: [
      '📭 อีเมลที่พนักงานส่งไปแล้วลูกค้าแค่กด 👍/🎉 ตอบกลับ ไม่ขึ้นเป็น "เมลค้างตอบ" อีก — ระบบมองข้ามข้อความที่เป็น emoji ล้วน แล้วดูข้อความจริงใบก่อนหน้า',
      '🛡️ ปลอดภัย: ถ้าลูกค้าตอบมี "ข้อความจริง" (แม้จะมี emoji ปน) ยังนับค้างเหมือนเดิม ไม่ซ่อนเมลจริง',
    ],
  },
  {
    version: 'v3.33',
