...
export const CHANGELOG = [
  {
    version: 'v3.55',
    date: '2026-07-20',
    title: 'Petty Cash · เปลี่ยนคำ "ไร้ใบเบิก" → "ไม่ผ่านฟอร์ม"',
    badge: 'Current',
    changes: [
      '💬 ป้าย "ไร้ใบเบิก" อ่านเข้าใจยาก เปลี่ยนเป็น "ไม่ผ่านฟอร์ม" — สื่อตรง ๆ ว่ารายการนี้ไม่ได้มาจากฟอร์มที่พนักงานกดเบิก (คำอธิบายใน ? เหมือนเดิม)',
    ],
  },
  {
    version: 'v3.54',
