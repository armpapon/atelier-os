  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px 14px' }}>
        ...
        <button onClick={onClose} aria-label="ปิด" title="ปิด" style={{ background: 'transparent', border: 0, color: 'var(--text-secondary)', fontSize: 14, cursor: 'pointer' }}><Icon name="x" size={15} /></button>
      </div>
